...
See the [Module Sync Guide](docs/usage_tips/module_sync.md), [Mappings Guide](docs/usage_tips/mappings.md), and [Rules & Patterns Guide](docs/usage_tips/rules_and_patterns.md) for details.
...
- Device Type
- Platform (via [Platform Mappings](docs/usage_tips/mappings.md#platform-mappings))
...
- Type (with [custom mapping support](docs/usage_tips/mappings.md#interface-type-mappings))
- Speed
- MTU
- MAC Address
