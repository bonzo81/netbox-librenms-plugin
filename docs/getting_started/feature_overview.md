...
## [Cable Sync](../device_sync/cable_sync.md) {#cable-sync}

* Create Cable connection in NetBox from LibreNMS links data
* Sync console-server serial ports (Avocent ACS, Cisco async lines — [configurable](../device_sync/cable_sync.md#configuring-recognized-sensor-types)) from LibreNMS sensors to ConsoleServerPort ↔ ConsolePort cables
